...
#define NUM_VALID_SQUARES_ON_BOARD 18

class Board
{
    vector<Square>  m_square_vec(NUM_SQUARES_ON_BOARD); // Representation of the board.
    map<uint8_t>    m_camelSquare_map; // Lookup table to map camel to its current square.
